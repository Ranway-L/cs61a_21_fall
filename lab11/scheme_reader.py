...
def scheme_read(src):
    ...
    """
    # print('DEBUG: Step in scheme_read')
    ...
    if val == 'nil':
        ...
        # BEGIN PROBLEM 3
        # print('DEBUG: Here am I', val, "--", src.current_line)
        "*** YOUR CODE HERE ***"
...
def read_tail(src):
    ...
    try:
        ...
        if src.current() is None:
            ...
            # BEGIN PROBLEM 2
            "*** YOUR CODE HERE ***"
            return Pair(scheme_read(src), read_tail(src))   #相互递归，遇到(就进入read_tail，
            # END PROBLEM 2
    except EOFError:
        raise SyntaxError('unexpected end of file')
